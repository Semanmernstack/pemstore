...
function Header() {
    ...
    return (
      <div className="flex p-1 items-center h-20 md:p-3 p-1 lg:p-6 bg-slate-500  sticky top-0 z-20">
          ...
          <div onClick={() => router.push("/checkout")} className="relative flex items-center mr-2">
              ...
              <p className="absolute left-6 top-0 text-sm text-white mr-4  ">{items?.length}</p>
          </div>
          </div>
