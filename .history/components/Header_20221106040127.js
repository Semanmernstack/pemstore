...
function Header() {
    ...
    return (
      <div className="flex  items-center h-20 md:p-3  lg:p-6 bg-slate-500  sticky top-0 z-20">
          ...
          <div onClick={() => router.push("/checkout")} className="relative flex items-center mr-4">
