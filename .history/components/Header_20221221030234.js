...
function Header() {
    ...
    return (
      <div className="flex  items-center   h-20 md:p-2  lg:p-5 bg-gray-500  sticky top-0 z-20">
          <div onClick={() => router.push("/")} className="mr-3  text-3xl md:text-5xl lg:text-6xl">
              <h1 className="cursor-pointer ">pemStore</h1>
          </div>
          <div className=" flex w-20   items-center flex-grow  p-1 cursor-pointer rounded-full ">
              <input className=" outline-none  rounded-full   " type="text" placeholder="Search for product..." />
