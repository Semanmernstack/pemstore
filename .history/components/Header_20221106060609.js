...
function Header() {
    ...
    return (
      <div className="flex  items-center   h-20 md:p-2  lg:p-5 bg-slate-500  sticky top-0 z-20">
          ...
          <div className=" flex w-20   items-center flex-grow bg-slate-300 p-1 cursor-pointer rounded-full ">
          ...
          <div onClick={() => router.push("/checkout")} className="relative flex items-center ">
              ...
              <p className="absolute left-6 bottom-10 text-sm text-white   ">{items?.length}</p>
          </div>
          </div>
